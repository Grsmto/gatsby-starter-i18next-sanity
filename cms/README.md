...
If you change a schema, you'll need to run the following command to udpate the GraphQL API:

- For staging: `npx sanity graphql deploy --dataset staging`
- For production: `npx sanity graphql deploy --dataset production`

Also don't forget to deploy your changes:
`npm deploy`
